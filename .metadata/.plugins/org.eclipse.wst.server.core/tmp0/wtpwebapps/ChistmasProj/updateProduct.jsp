...
<body>
	...
	<div class="jumbotron">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-5">
				<img src="D:/JSP/ChristmasProject/image/<%=rs.getString("p_fileName") %>" style="width:100%" alt="image"/>
			</div>
			<div class="col-md-7">
				<form name="newProduct" action="./processUpdateProduct.jsp"
					...
					<div class="form-group row">
						<label class="col-sm-3">판매자</label>
						<div class="col-sm-6">
							<input type="text" name="seller" class="form-control" 
							value="<%=rs.getString("p_seller") %>">
						</div>
					</div>	
					<div class="form-group row">
						<label class="col-sm-3">크기</label>
						<div class="col-sm-6">
							<input type="text" id="length" name="length" class="form-control" 
							value="<%=rs.getInt("p_length") %>">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-3">연식</label>
						<div class="col-sm-6">
							<input type="text" id="older" name="older" class="form-control" 
							value="<%=rs.getInt("p_older") %>">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-3">재료</label>
						<div class="col-sm-6">
							<input type="text" name="material" class="form-control" 
							value="<%=rs.getString("p_material") %>">
						</div>
					</div>	
					<div class="form-group row">
